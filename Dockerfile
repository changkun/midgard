...
RUN cd /root/goes && wget https://dl.google.com/go/go1.16beta1.linux-amd64.tar.gz 
RUN cd /root/goes && tar xvf go1.16beta1.linux-amd64.tar.gz && rm go1.16beta1.linux-amd64.tar.gz 
RUN cd /root/goes && mv /root/goes/go /root/goes/go1.16beta1 
RUN cd /root/goes && ln -s /root/goes/go1.16beta1 /root/goes/go 
